const canvasRectangle = document.getElementById('canvas__rectangle')
const canvasTriangle = document.getElementById('canvas__triangle')
const canvasFeather = document.getElementById('canvas__feather')
const canvasLines = document.getElementById('canvas__lines')
const canvasArches = document.getElementById('canvas__arches')
const canvasCurves = document.getElementById('canvas__curves')
const canvasCubicCurves = document.getElementById('canvas__cubic__curves')
const canvasRoundedRect = document.getElementById('canvas__rounded_rect')
const canvasPath2D = document.getElementById('canvas__path2D')
...
function drawArches() {
    ...
    if (canvasArches.getContext) {
        const ctx = canvasArches.getContext("2d");
...
function drawCurves() {
    ...
    if (canvasCurves.getContext) {
        const ctx = canvasCurves.getContext("2d");
...
function drawCubicCurves() {
    ...
    if (canvasCubicCurves.getContext) {
        const ctx = canvasCubicCurves.getContext("2d");
...
function drawRoundedRect() {
    if (canvasRoundedRect.getContext) {
        const ctx = canvasRoundedRect.getContext("2d");
